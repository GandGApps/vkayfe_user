...
export function ShopFavorite({item, addFavoriteFunc, navigation,index}) {
    ...
    return (
        // item.delivery && (
        <TouchableOpacity style={styles.applicationsContainer} onPress={() => navigation.navigate(GoodsDataName, {item})}>
            ...
            <View style={styles.foot}>
                <View style={styles.applContent}>
                    ...
                    <Text style={[globalStyles.titleText,globalStyles.titleTextSmall,globalStyles.textAlignLeft,styles.name]}>{item.title}</Text>
                </View>
                <View style={styles.applicationsContent}>
                    <View style={styles.shopCont}>
                        <Text style={[globalStyles.titleText,globalStyles.titleTextSmall4,globalStyles.textAlignLeft,globalStyles.weightLight,styles.name1]}>{item.city}</Text>
                    </View>
