...
import {BaseUrl, globalStyles, GoodsDataName, ShopName} from "../../../constants";
        ...
        <TouchableOpacity style={styles.applicationsContainer} onPress={() =>{
            ...
            <View style={styles.foot}>
                <View style={styles.applContent}>
                    ...
                    <Text style={[globalStyles.titleText,globalStyles.titleTextSmall,globalStyles.textAlignLeft,globalStyles.weightBold,styles.name]}>{item.store_id.title}</Text>
                </View>
                <View style={styles.applicationsContent}>
                    <View style={styles.shopCont}>
                        <Text style={[globalStyles.titleText,globalStyles.titleTextSmall4,globalStyles.textAlignLeft,globalStyles.weightLight,styles.name1]}>{item.store_id.city} / {item.store_id.address}</Text>
                    </View>
                </View>
            </View>
        </TouchableOpacity>
