    ...
    return (
        ...
        if(!loading) {
            ...
            <View style={styles.formContent}>
                ...
                <Text
                  numberOfLines={1}  style={[globalStyles.titleText, globalStyles.weightBold, globalStyles.titleTextSmall, globalStyles.textAlignLeft, styles.goodsText]}>{item.price.$numberDecimal ? item.price.$numberDecimal  : item.price} р</Text>
            </View>
        </TouchableOpacity>
    );
}
