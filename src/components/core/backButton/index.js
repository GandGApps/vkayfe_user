...
export function BackButton({ navigation, text, pending, textStyle, stylesBack, deleteAll, applications,like,favorite,changeFav }) {
  ...
  return (
    <View style={[styles.container, stylesBack, globalStyles.row]}>
      ...
      {like &&
          ...
          <Image source={favorite ? likeTifany : dntLike} style={styles.likeIc}/>
          </TouchableOpacity>}
    </View>
