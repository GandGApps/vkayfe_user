...
import {
    ...
    AppForm,
    AppInput,
    BackButton, globalWidth, Loading,
    passwordValidate,
    validateEmail,
} from "../../../components";
                        ...
                        <View>
                            ...
                            <View style={styles.switchContainer}>
                                ...
                                <View style={styles.switchContainerText}>
                                    <Text style={[globalStyles.titleText, globalStyles.titleTextSmall, styles.checkStyle]}>Я соглашаюсь
                                        с </Text>
                                    <TouchableOpacity style={styles.touchCont} onPress={() => {
                                        ...
                                        <Text style={[globalStyles.titleText, globalStyles.titleTextSmall, styles.SignInTextBold]}>Политикой конфиденциальности</Text>
                                    </TouchableOpacity>
                                    <Text style={[globalStyles.titleText, globalStyles.titleTextSmall, styles.checkStyle]}> и </Text>
                                    <TouchableOpacity style={styles.touchCont} onPress={() => {
                                        navigation.navigate(LoremName, {
                                        ...
                                        <Text
                                            style={[globalStyles.titleText, globalStyles.titleTextSmall, styles.SignInTextBold]}>Условиями использования приложения</Text>
                                    </TouchableOpacity>
