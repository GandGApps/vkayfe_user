...
import {MapsScreenName, ProfileScreenName, SET_CUSTOMER} from "../../../../constants";
import axiosInstance from "../../../../networking/axiosInstance";
import {globalStyles, Colors, DeleteShopName, AddPromoCodeName, OkayPromoName} from "../../../../constants";
import {AppButton, BackButton, PromoCodeForm, PromoCodeData, AppInput} from "../../../../components";
        ...
        <ScrollView contentContainerStyle={globalStyles.scrollContainer} bounces={false}>
            ...
            <View style={[styles.content]}>
                <View style={styles.cont}>
                    ...
                    <View>
                        <Text
                            style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall4, styles.headerText]}>Событие</Text>
                        <AppInput
                        ...
                        <View style={[globalStyles.row, styles.contentCont]}>
                            <View>
                                <Text
                                    style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall4, , styles.headerTextData]}>Дата</Text>
                                <TouchableOpacity style={[globalStyles.row, styles.calCont]}
                            ...
                            <View style={styles.inpStyle}>
                                <Text
                                    style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall4, , styles.headerTextPromoCode]}>Промокод</Text>
                                <AppInput
                        ...
                        <Text
                            style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.weightLight, , styles.sale]}>Скидка
                            5%</Text>
                    </View>
                </View>
