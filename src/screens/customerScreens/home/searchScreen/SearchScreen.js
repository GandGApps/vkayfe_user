        ...
        <View style={[globalStyles.container, styles.cont]}>
            <View style={styles.headerSearch}>
                ...
                <View style={styles.headerContent}>
                    <TouchableOpacity style={styles.filterContainer} onPress={() => navigation.navigate(FilterName,{state:true})}>
                        <Text
                ...
                <View style={styles.contView}>
                    <Text  style={[globalStyles.titleText, globalStyles.titleTextSmall, globalStyles.weightBold, globalStyles.textAlignLeft, styles.recText]}>
                        Мы нашли 20 товаров
                    </Text>
