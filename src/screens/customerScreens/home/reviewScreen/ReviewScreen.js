...
import {Colors, FilterName, globalStyles, MapsScreenName, ShopName} from "../../../../constants";
import {
    CategoryData,
    FormCategory,
...
export const ReviewScreen = ({navigation, route}) => {
    ...
    const axiosFunc = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(`/stores/reviews?store_id=${route.params.shop._id}`, obj)
    ...
    return (
        <View style={[globalStyles.container, styles.cont]}>
            ...
            <View>
                ...
                <View>
                    <Text
                        style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall, globalStyles.weightBold, styles.priceText]}>Ваше
                        имя</Text>
                    <AppInput
                ...
                <View>
                    <Text
                        style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall, globalStyles.weightBold, styles.priceText]}>Мой
                        отзыв</Text>
                    <AppInput
